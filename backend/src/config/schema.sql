-- ═══════════════════════════════════════════════════════════════
-- CivicsPulse — Complete Database Schema
...
CREATE INDEX idx_report_card_requests_requester
  ON report_card_requests(requester_id, created_at DESC);
CREATE INDEX idx_report_card_requests_status
  ON report_card_requests(status, created_at DESC);
CREATE INDEX idx_report_card_requests_rep
